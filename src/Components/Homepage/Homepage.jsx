...
function Homepage() {
    ...
    <div>
        ...
        <div className='bg-colorg w-full h-96 text-colorb'>
            <div className="m-auto flex h-full w-5/6 items-center">
                <div className="w-1/2 h-full">
                    <div className="relative h-2/5 w-4/5 m-4 p-4 xl:block bg-white shadow-pathcard">
                        <div className="">
                ...
                <div className="w-full space-y-8 px-4 xl:w-1/2">
                    ...
                    <p className="max-w-[60ch] font-thin text-left">Choose from <span className="font-bold"> 47 </span> learning paths.</p>
                </div>
            </div>
        </div>
        ...
        <div className='bg-white w-full h-96 pt-10  text-colora'>
            <div className="mx-auto flex h-full w-3/5 items-center justify-center">
                ...
                <div className="w-full space-y-8 px-4 xl:w-1/2">
                    ...
                    <p className="max-w-[60ch] font-thin text-left">Check your learning progress and completed courses in your profile.</p>
                </div>
            </div>
        </div>

        <div className='bg-colore/70 w-full h-96  text-white'>
            <div className="mx-auto flex h-full w-3/5 items-center justify-center">
                <div className="w-full space-y-8 px-4 xl:w-1/2">
                    <h1 className="text-5xl text-left">Join us!</h1>
                    <p className="max-w-[60ch] font-thin text-left"></p>
                </div>
            </div>
        </div>
    </div>
