    ...
    <div>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900">Available certifications</h1>
            ...
            <table className="table-auto w-full">
                ...
                <tbody>
                    {data.map((certificate) =>                   
                            <tr key={certificate.id} onClick={onClickHref} className="cursor-pointer hover:bg-colorf">
...
export default CertificationsGuest;
